...
public class ModBlocks {
    ...
    public static final Block PEAR_PIE = registerBlock("pear_pie", new CakeBlock(FabricBlockSettings.copyOf(Blocks.CAKE).hardness(0.5F).sounds(BlockSoundGroup.WOOL)));
